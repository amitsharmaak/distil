...
CREATE TABLE research_reports (
  id text PRIMARY KEY, item_id text, query text NOT NULL, report text NOT NULL DEFAULT '',
...
CREATE TABLE research_suggestions (
  ...
  research_report_id text, created_at timestamptz NOT NULL
);
...
CREATE INDEX rate_limit_expiry_idx ON rate_limit_windows((window_start + make_interval(secs => window_seconds)));
