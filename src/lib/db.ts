...
/** Deletes every generated summary for an item. */
export function deleteAISummaries(itemId: string): void {
  db.prepare("DELETE FROM ai_summaries WHERE item_id = ?").run(itemId);
}
