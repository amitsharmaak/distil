...
export function DetailActionBar({
  ...
  return (
    <div className="distil-action-bar fixed bottom-16 left-0 right-0 z-50 border-t border-border/40 bg-background/80 backdrop-blur-xl md:bottom-0 md:left-16 lg:left-64 transition-[left] duration-300">
